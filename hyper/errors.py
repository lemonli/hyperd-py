...
class APIError(requests.exceptions.HTTPError, HyperException):
    """
...
class InvalidArgument(HyperException):
    pass
...
class TLSParameterError(HyperException):
...
class ContainerError(HyperException):
    """
...
class BuildError(HyperException):
...
class ImageLoadError(HyperException):
    pass
