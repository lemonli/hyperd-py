...
if 'hyper-py' in [x.project_name for x in pip.get_installed_distributions()]:
    print(
        'ERROR: "hyper-py" needs to be uninstalled before installing this'
        ' package:\npip uninstall hyper-py', file=sys.stderr
    )
    sys.exit(1)
...
extras_require = {
    ...
    # If using hyper-py over TLS, highly recommend this option is
...
version = None
exec(open('hyper/version.py').read())
...
setup(
    name="hyper",
    version=version,
    description="A Python library for the hyper Engine API.",
    ...
    maintainer='Wenjun Li',
    maintainer_email='lemonlwj@126.com',
)
